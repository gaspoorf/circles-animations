...
projects.forEach((project, index) => {
  project.addEventListener('click', () => {
    ...
    if (!project.classList.contains('active')) {
      ...
      const carouselLeft = window.innerWidth < 768 ? window.innerWidth * 1.5 : window.innerWidth;
      const carouselCenter = -carouselLeft + (window.innerWidth / 2);
      ...
      gsap.to(activeBackground, { 
        ...
        onComplete: () => {
          ...
          // activeBackground.style.cursor = 'pointer';
        }
      });
    }
  });
